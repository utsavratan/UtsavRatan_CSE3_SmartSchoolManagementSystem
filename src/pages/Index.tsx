...
export default function Index() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <div className="relative h-screen overflow-hidden bg-gradient-to-br from-purple-600 via-violet-500 to-indigo-700">
        <div className="absolute inset-0 w-full h-full">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_600px,rgba(168,119,198,0.3)_0%,rgba(255,255,255,0)_60%)]"></div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <motion.div
                ...
                className="mb-6"
              >
                <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent mb-3 tracking-tight">
                  EduTrack
                </h1>
                <div className="h-1 w-24 md:w-32 bg-gradient-to-r from-purple-400 to-indigo-300 mx-auto rounded-full mb-4"></div>
              </motion.div>
              ...
              >
                <h2 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">
                  {heroSlides[currentSlide].heading}
                </h2>
                <p className="mt-3 text-md md:text-lg text-purple-100">
              ...
              >
                <Link to="/login">
                  <Button 
                    size="lg" 
                    className="bg-white text-purple-700 hover:bg-purple-100 hover:scale-105 transform transition-all duration-200 group"
                  >
                    Get Started
              ...
              <motion.div
                className="pt-8 md:pt-10 flex gap-6 md:gap-10 justify-center"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                <div className="flex flex-col items-center">
                  <div className="flex items-center">
                    <GraduationCap className="h-4 w-4 mr-1 md:h-5 md:w-5 md:mr-2 text-purple-300" />
                ...
                <div className="flex flex-col items-center">
                  <div className="flex items-center">
                    <Clock className="h-4 w-4 mr-1 md:h-5 md:w-5 md:mr-2 text-purple-300" />
      ...
      {/* Stats Section */}
      <section ref={statsRef} className="py-16 bg-gradient-to-r from-purple-600 to-indigo-700 text-white relative overflow-hidden">
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="flex flex-col h-full">
                  <div className="mb-4">
                    <svg className="h-8 w-8 text-purple-600" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
      ...
      {/* Developers Section */}
      <section ref={developerRef} className="py-20 bg-gradient-to-r from-purple-600 via-violet-500 to-indigo-700 text-white relative overflow-hidden">
        <div className="absolute inset-0 w-full h-full">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(168,119,198,0.3)_0%,rgba(255,255,255,0)_60%)]"></div>
        </div>
            ...
            {developers.map((dev, index) => (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-r from-purple-400 to-indigo-400 flex items-center justify-center mb-4">
                  ...
                  <p className="text-purple-300 text-sm mb-2">{dev.university}</p>
                  <p className="text-purple-300 text-sm mb-3">{dev.email}</p>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-b from-indigo-700 to-purple-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 w-full h-full">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(168,119,198,0.3)_0%,rgba(255,255,255,0)_60%)]"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <Link to="/login">
              <Button 
                size="lg" 
                className="bg-white text-purple-700 hover:bg-purple-100 hover:scale-105 transform transition-all duration-200"
              >
                Get Started Today
              </Button>
            </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div>
              ...
              <p className="text-purple-300 text-sm">Smart School Management System</p>
            </div>
